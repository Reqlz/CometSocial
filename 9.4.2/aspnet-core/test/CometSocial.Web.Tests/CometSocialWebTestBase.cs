...
{
    public abstract class CometSocialWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static CometSocialWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(CometSocialWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<CometSocialDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<CometSocialDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<CometSocialDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<CometSocialDbContext, Task<T>> func)
        {
            T result;
