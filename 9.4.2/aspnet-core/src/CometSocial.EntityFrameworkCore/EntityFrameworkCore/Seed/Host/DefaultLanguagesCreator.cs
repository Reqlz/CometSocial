...
namespace CometSocial.EntityFrameworkCore.Seed.Host
{
    public class DefaultLanguagesCreator
    {
        public static List<ApplicationLanguage> InitialLanguages => GetInitialLanguages();

        private readonly CometSocialDbContext _context;

        private static List<ApplicationLanguage> GetInitialLanguages()
        {
            var tenantId = CometSocialConsts.MultiTenancyEnabled ? null : (int?)MultiTenancyConsts.DefaultTenantId;
        ...
        public DefaultLanguagesCreator(CometSocialDbContext context)
        {
            _context = context;
        }
